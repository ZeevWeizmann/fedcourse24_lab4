...
if __name__ == "__main__":
    ...
    # Save the final accuracy for this experiment
    final_acc = aggregator.last_test_metric

    with open(f"{args.logs_dir}/final_acc.txt", "w") as f:
         f.write(str(final_acc))

    print(f"\nFinal Test Accuracy: {final_acc}")
    print(f"Saved to: {args.logs_dir}/final_acc.txt")
